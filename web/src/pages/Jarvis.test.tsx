...
it("renders real task usage, execution summary and final result in the same thread", async () => {
  ...
  const usage = { has_data: true, requests: 3, total_tokens: 4441, input_tokens: 4000, output_tokens: 441, reasoning_tokens: null, cached_input_tokens: null, cache_write_tokens: null, other_tokens: null, cost_total: 0.001, currency: "USD", cache_hit_rate: null, cache_hit_tokens: null, cache_miss_tokens: null, token_cache_hit_ratio: null, cache_doctor: { application_prefix: { stability: null, reusable_prefix_tokens: null, status: "Unavailable" }, provider_cache: { status: "Unavailable", hit_tokens: null, miss_tokens: null, write_tokens: null, hit_ratio: null }, capability: { source: "UNKNOWN", confidence: "UNKNOWN", strategy: "passive" }, bust_reason: null, privacy: "HASHES_AND_SIZES_ONLY" }, runtime_ms: 18000, average_latency_ms: 6000, usage_source: "REPORTED", last_compression: null, context: { current_tokens: 140000, limit: 1000000, percentage: .14, status: "AMPLE", compression_threshold: .8, compression_threshold_tokens: 800000, until_compression: 660000, source: "REPORTED", role: "researcher", model: "deepseek-v4-flash" }, by_agent: [{ name: "researcher", requests: 3, tokens: 4441, latency_ms: 18000, cost: .001, cost_available: true }], by_model: [], by_provider: [], by_task: [], timeline: [] } satisfies UsageSummary;
